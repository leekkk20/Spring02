...
public class CalendarController {
	...
	public ModelAndView calendarMain(HttpServletRequest request, ModelAndView mv, CalendarVO vo,
			ArrayList<CalendarVO> alist) {
	...
	public ModelAndView calendarInsert(HttpServletRequest request, ModelAndView mv, CalendarVO vo) {
		...
		if (vo.getCaid() != null) {
			if (service.insert(vo) > 0)
				mv.addObject("fCode", "200"); // 입력성공
			else
				mv.addObject("fCode", "201"); // 입력실패
		} else
			mv.addObject("fCode", "202"); // 입력 Id = null
